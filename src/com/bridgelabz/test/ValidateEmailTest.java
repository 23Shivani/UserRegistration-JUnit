...
public class ValidateEmailTest {
	private UserRegistrationMain UserRegistrationMain;
	private boolean expectedResult;
	private String emailId;

	public ValidateEmailTest(String emailId, boolean expectedResult) {
		super();
	...
	public void initialize() {
		UserRegistrationMain = new UserRegistrationMain();
	}
	...
	public void givenEmailIds_WhenProper_ShouldReturnExpectedResult() {
		boolean result = UserRegistrationMain.validateEmailId(emailId);
		Assert.assertEquals(this.expectedResult, UserRegistrationMain.validateEmailId(emailId));
	}
}
